define(function (require) {
  ...
  return function KibiSelectHelperFactory(
    config, $http, kbnPath, courier, indexPatterns, timefilter, Private, Promise/*, kbnIndex*/
    ) {
    ...
    var searchRequest = function (type) {
      return $http.post(kbnPath + '/db/.kibana-4/' + type + '/_search?size=100', {"query":{"match_all":{}}});
    };
