...
L.Control.MousePosition = L.Control.extend({
  ...
  _toggleFormatters: function _toggleFormatters(e) {
    if (this.options.lngFormatters.length === 0 || this.options.lngFormatters.length !== this.options.latFormatters.length) return;
