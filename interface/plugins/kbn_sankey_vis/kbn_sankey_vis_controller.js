...
_ = require('lodash');
$ = require('jquery');
S = require('./lib/d3-plugins-sankey/sankey');
sankeyAggResponseProvider = require('./lib/agg_response');
uiModules = require('ui/modules');

var module = uiModules.get('kibana/kbn_sankey_vis', ['kibana']);

module.controller('KbnSankeyVisController', function ($scope, $element, Private) {

  var sankeyAggResponse = Private(sankeyAggResponseProvider);
