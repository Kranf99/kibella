    ...
    return {
      ...
      link: function ($scope, $el) {
        ...
        $scope.$watch('id', function (id) {
          ...
          // Remove on the fly the index of the savedObj (panel header title)
          // example: title:"INCOME(income): educations" -> title:"educations"
          function removeIndexFromTitle(title) {
            return title.split(':')[1];
          }
          $scope.savedObj.title = removeIndexFromTitle($scope.savedObj.title);
